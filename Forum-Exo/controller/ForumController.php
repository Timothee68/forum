        ...
        if($_SESSION['user']){
            ...
            if(isset($_POST['submit']) && empty($_POST['submit']))
            {
                ...
                if(isset($title,$categorie)){
                   ...
                   $idTopic = $topicManager->addNewTopic([ "user_id" => $user ,"title" => $title,"categorie_id" => $categorie]);
            ...
            if($_POST["submit"]){
                ...
                { 
                    ...
                    return [
                        ...
                        "data" => [
                            "search" => $topicManager->searchTopic(["title" =>'%'.$data.'%']),
                            "search2" => $messageManager->searchMessage(["text" =>'%'.$data.'%']),
                            "search3" => $userManager->searchUser(["pseudo"=>'%'.$data.'%']),
                            "categories" => $categorieManager->findAll(),
                        ]
                    ];
                }
